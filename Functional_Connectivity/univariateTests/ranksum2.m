function [pVals, sig,stats]=ranksum2(CMs1,CMs2,qVal, varargin)
...
for r=1:nVars1
    for c=r:nVars1
        ...
        %[p,h]=ranksum(CMs1(r,c,:),CMs2(r,c,:));
        [p,h,stats]=ranksum(squeeze(CMs1(r,c,:)),squeeze(CMs2(r,c,:)),'alpha',qVal); %DVDV     
        pVals(r,c)=p;
        pVals(c,r)=p;
    end
end
